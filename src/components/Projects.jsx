...
const projectsList = [
  { id: 1, name: 'Event Finder: React Web Application and Android Application', description: 'Developed a React web and Android app integrating Ticketmaster, IPinfo, and Spotify APIs for event discovery and user favorites.', link: 'http://example.com/project-one', github: 'https://github.com/mahek-sota/event-finder', techstack: 'HTML, CSS, JS, React, NodeJS, RESTFul API, localStorage, GIT, GCP, Bootstrap, Android Studio, Java.' },
  { id: 2, name: 'Work It: Fitness Web Application', description: 'Led the creation of a fitness web app with a chatbot, video calls, and a recipe recommender, achieving high accuracy in both chatbot and recommendation systems.', link: 'http://example.com/project-two', github: 'https://github.com/mahek-sota/work-it', techstack: 'HTML, CSS, JS, React, Flask, ChatterBot, BeautifulSoup, NLP techniques - cosine similarity, Word2Vec.' },
  { id: 3, name: 'RNN and LSTM Model for Sentimental Analysis', description: 'Built an NLP model for Amazon review sentiment analysis using RNN and LSTM', link: 'http://example.com/project-three', github: 'https://github.com/mahek-sota/sentimental-analysis', techstack: 'Python, PyTorch, Word2Vec, RNN, LSTM' },
